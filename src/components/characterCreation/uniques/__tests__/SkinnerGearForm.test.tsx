...
import { mockPlayBookCreatorQueryHardHolder, mockPlayBookCreatorQuerySkinner } from '../../../../tests/mockQueries';
...
describe('Rendering SkinnerGearForm', () => {
  ...
  test('should render SkinnerGearForm in intial state', async () => {
